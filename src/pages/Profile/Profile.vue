<template>
    <div class="g-content">
        ...
        <Form  v-else ref="infoForm" :model="infoForm" :rules="validate" :label-width="110" style="width:700px">
            ...
            <Form-item label="头像：">
                <!-- 组件-图片上传-单图片显示 -->
                <ImageCropper :src="infoForm.headPortrait" :preview="true" @get-img-url="setFace"></ImageCropper>
            </Form-item>
...
<script>
    ...
    export default {
		...
		data(){
			return {
                ...
                infoForm: {
                    ...
                    realName: '',
                    // 头像图片地址
                    headPortrait: require('@/assets/images/default-face.jpg'),
                    // 性别
                    gender: '男',
                },
				// 验证规则
        ...
        methods:{
            ...
            getProfile(){
                ...
                .then(res => {
                    ...
                    if(res.code == 200){
                        ...
                        this.$store.commit('SET_USER_FACE', this.infoForm.headPortrait.url);
                    }
            ...
            setFace(url){
                console.log(url);
                this.infoForm.headPortrait = url;
            }
        }
	}
</script>
